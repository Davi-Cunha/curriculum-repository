...
public class Exemplo002_v10
{
 // definir construtores/funcoes/procedimentos
   ...
   /**
      Funcao para achar quantos sao os valores em um intervalo.
      @return a quantidade de valores, se existir; ou zero, caso contrario
      @param  resposta - cadeia de caracteres a ser analisada
   */
   public static int acharQuantosNoIntervalo ( String resposta )
   {
    // definir dados locais
       int     contador   =   0 ;
    ...
    // testar a existencia de valores na resposta
       if ( resposta == null )
       {
          IO.println ( "ERRO: Nao ha' dados suficientes." );
       }
       else
       {
   ...
   /**
      Funcao para achar quantos sao os valores em um intervalo (recursivamente).
      @return a quantidade de valores, se existir; ou zero, caso contrario
      @param  resposta - cadeia de caracteres a ser analisada
   */
   public static int acharQuantosNoIntervaloR2 ( String resposta, int posicao )
   {
    // definir dados locais
       int     contador   =   0 ;

       if ( resposta != null && posicao >= 0 )
       {
          if ( resposta.charAt(posicao) == ' ' )
          {
             contador = 1;
          } // fim for
          contador = contador + acharQuantosNoIntervaloR ( resposta, posicao-1 );
       } // fim if
       return ( contador );
   } // fim
   ...
   /**
      ...
      @param  resposta - cadeia de caracteres a ser analisada
   */
   public static int acharQuantosNoIntervaloR ( String resposta, int posicao )
   {
    // definir dados locais
       int     contador   =   0 ;
       ...
       if ( resposta != null && posicao >= 0 )
       {
          contador = acharQuantosNoIntervaloR ( resposta, posicao-1 );
          if ( resposta.charAt(posicao) == ' ' )
          {
             contador = contador + 1;
          } // fim for
   ...
   /**
      ...
      @param  resposta - cadeia de caracteres a ser analisada
   */
   public static int acharQuantosNoIntervaloR ( String resposta )
   {
    // definir dados locais
       int     contador   =   0 ;
    ...
    // testar a existencia de valores na resposta
       ...
       else
       {
          ...
          if ( tamanho > 0 )
          {
             contador = acharQuantosNoIntervaloR ( resposta, tamanho-1 );
          } // fim
       } // fim if
 ...
 */
 public static void main ( String [ ] args )
 {
  ...
  // identificar
     IO.println ( "Exemplo002 - versao 0.10 - 2018" );
  ...
  // testar a existencia de valores na resposta
     contador = acharQuantosNoIntervaloR ( resposta );
  //   IO.println ( "resposta = "+contador+" valores" );
     IO.println ( "resposta = "+resposta+" (="+contador+" valores)" );
