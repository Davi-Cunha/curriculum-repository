...
public class Exemplo002_v05
{
 // definir construtores/funcoes/procedimentos
   ...
   */
   public static void acharQuantosNoIntervalo ( String resposta )
   {
    // definir dados locais
       int     tamanho    =   0 ;
       int     posicao    =   0 ;
 ...
 */
 public static void main ( String [ ] args )
 {
  ...
  // identificar
     IO.println ( "Exemplo002 - versao 0.5 - 2018" );
  ...
  // testar a existencia de valores na resposta
     acharQuantosNoIntervalo ( resposta );
