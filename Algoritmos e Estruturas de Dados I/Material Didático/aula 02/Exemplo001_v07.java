...
/**
   Modelo de classe.
*/
public class Exemplo001_v07
{
 // definir construtores/funcoes/procedimentos
    public static void acharValoresNoIntervalo
 ...
 */
 public static void main ( String [ ] args )
 {
  ...
  // identificar
     IO.println ( "Exemplo001 - versao 0.7 - 2018" );
  ...
  // testar se quantidade valida
     ...
     else
     {
      ...
      // testar se os limites sao validos
         ...
         {
             acharValoresNoIntervalo ( quantidade, inferior, superior );
         } // fim
     } // fim
